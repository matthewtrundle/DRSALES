          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-neutral-400">
                Subscribe to receive updates on the latest advancements in eye care and surgical techniques.
              </p>
            </div>
            <form onSubmit={handleNewsletterSubmit} className="flex gap-3">
              <div className="flex-grow relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold transition-all"
                  required
                />
                {isSubscribed && (
                  <div className="absolute -bottom-8 left-0 text-sm text-gold animate-fade-in">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-gold hover:bg-gold-600 text-white font-medium rounded-lg transition-colors flex-shrink-0"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-neutral-400 mb-4">
              ...
              vision correction, and innovative surgical techniques.
            </p>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-neutral-800 hover:bg-gold flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-300"
