          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-2xl">
                <Image
                  src="/images/ToUse/glasses-freedom.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-neutral-600 leading-relaxed">
                ...
                <p>
                  Unlike laser procedures that permanently reshape your cornea, the EVO ICL is additive and reversible. The lens can be removed if you ever need it for any reason.
                </p>
                <p>
